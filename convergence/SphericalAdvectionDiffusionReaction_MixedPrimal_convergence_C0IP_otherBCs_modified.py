...
There is an issue with setting up a Dirichlet condition on the "outflow boundary" because the upstream mechanism does not work. Burman-He 2019 proposes to impose the Dirichlet on the outflow weakly. This can be done as in the code or with, e.g. 
